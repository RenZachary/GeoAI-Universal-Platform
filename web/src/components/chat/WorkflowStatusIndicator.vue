        ...
        <div v-if="status" class="workflow-status">
            <div class="status-content">
                ...
                <div v-if="activeTools.length > 0" class="active-tools">
                    <el-tag v-for="tool in activeTools" :key="tool" size="small" type="info" effect="plain">
                        {{ tool }}
                    </el-tag>
                </div>
            </div>
...
.workflow-status {
    ...
    background: linear-gradient(90deg, #e5f3ff, #51a5fab7, #e5f3ff);
    background-size: 200% 100%;
    animation: loading-flow 1.5s infinite ease;
